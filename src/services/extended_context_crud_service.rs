use crate::models::context::{FeatureContext, ProjectConvention, SecurityPolicy};
use crate::repositories::{
    FeatureContextRepository, ProjectConventionRepository, SecurityPolicyRepository,
};
...
pub trait ExtendedContextCrudService: Send + Sync {
    ...
    ) -> Result<SecurityPolicy, McpError>;
    ...
    async fn list_security_policies_by_area(
        &self,
        project_id: &str,
        policy_area: &str,
    ) -> Result<Vec<SecurityPolicy>, McpError>;
    ...
    async fn create_project_convention(
        &self,
        project_id: &str,
        convention_type: Option<&str>,
        convention_rule: Option<&str>,
    ) -> Result<ProjectConvention, McpError>;
    async fn get_project_convention(&self, id: &str)
        -> Result<Option<ProjectConvention>, McpError>;
    async fn update_project_convention(
        &self,
        convention: &ProjectConvention,
    ) -> Result<ProjectConvention, McpError>;
    async fn delete_project_convention(&self, id: &str) -> Result<bool, McpError>;
    async fn list_project_conventions(
        &self,
        project_id: &str,
    ) -> Result<Vec<ProjectConvention>, McpError>;
    async fn list_project_conventions_by_type(
        &self,
        project_id: &str,
        convention_type: &str,
    ) -> Result<Vec<ProjectConvention>, McpError>;
    ...
    // Bulk operations
    async fn bulk_create_security_policies(
        &self,
        policies: &[SecurityPolicy],
    ) -> Result<Vec<SecurityPolicy>, McpError>;
    async fn bulk_update_security_policies(
        &self,
        policies: &[SecurityPolicy],
    ) -> Result<Vec<SecurityPolicy>, McpError>;
    async fn bulk_delete_security_policies(&self, ids: &[String]) -> Result<usize, McpError>;

    async fn bulk_create_project_conventions(
        &self,
        conventions: &[ProjectConvention],
    ) -> Result<Vec<ProjectConvention>, McpError>;
    async fn bulk_update_project_conventions(
        &self,
        conventions: &[ProjectConvention],
    ) -> Result<Vec<ProjectConvention>, McpError>;
    async fn bulk_delete_project_conventions(&self, ids: &[String]) -> Result<usize, McpError>;

    async fn bulk_create_feature_contexts(
        &self,
        contexts: &[FeatureContext],
    ) -> Result<Vec<FeatureContext>, McpError>;
    async fn bulk_update_feature_contexts(
        &self,
        contexts: &[FeatureContext],
    ) -> Result<Vec<FeatureContext>, McpError>;
    ...
    FCR: FeatureContextRepository,
{
    ...
    async fn list_security_policies(
        ...
        self.security_policy_repository
    ...
    async fn list_security_policies_by_area(
        ...
        self.security_policy_repository
            .list_by_policy_area(project_id, policy_area)
            .await
    }
    ...
    async fn get_project_convention(
        &self,
        id: &str,
    ) -> Result<Option<ProjectConvention>, McpError> {
    ...
    async fn list_project_conventions(
        ...
        self.project_convention_repository
            .list_by_project(project_id)
            .await
    }
    ...
    async fn list_project_conventions_by_type(
        ...
        self.project_convention_repository
            .list_by_convention_type(project_id, convention_type)
            .await
    }
    ...
    async fn create_feature_context(
        ...
        self.feature_context_repository
            .create(&feature_context)
            .await
    }
    ...
    async fn get_feature_context_by_name(
        ...
        self.feature_context_repository
            .get_by_feature_name(project_id, feature_name)
            .await
    }
